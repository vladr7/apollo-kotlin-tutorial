...
fun LaunchDetails(launchId: String, navigateToLogin: () -> Unit) {
    ...
    when (val result = state) {
        ...
        is LaunchDetailsState.ProtocolError -> ErrorMessage(
            result.exception.message ?: "Unknown error"
        )

        is LaunchDetailsState.Success -> LaunchDetails(result.data, navigateToLogin)
        is LaunchDetailsState.ApplicationError -> ErrorMessage(
